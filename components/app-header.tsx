    ...
    <header className="sticky top-0 z-50 w-full border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60 shadow-sm">
      <div className="container mx-auto px-3 sm:px-4 lg:px-8">
        <div className="flex h-14 sm:h-16 items-center justify-between gap-2">
          <Link href="/" className="flex items-center gap-2 sm:gap-3 transition-opacity hover:opacity-80 flex-shrink-0">
            ...
            <div className="hidden min-[380px]:block">
              <h1 className="text-base sm:text-lg font-bold leading-none text-foreground">SIGA</h1>
              <p className="text-[10px] sm:text-xs text-muted-foreground">Gestão de Alunos</p>
            </div>
          </Link>
              ...
              {displayNavItems.map((item) => {
                ...
                return (
                  <Button
                    ...
                    size="sm"
                    className={cn("gap-2 text-xs", isActive && "shadow-sm")}
                  >
                    <Link href={item.href}>
                ...
                <SheetHeader className="mb-6">
                  <SheetTitle className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground font-normal">Sistema de Gestão</div>
                    </div>
                  </SheetTitle>
                </SheetHeader>
                  ...
                  {displayNavItems.map((item) => {
                    ...
                    return (
                      <Button
                        ...
                        variant={isActive ? "default" : "ghost"}
                        size="lg"
                        className={cn("justify-start gap-3 text-base", isActive && "shadow-sm")}
