  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 overflow-hidden">
      <div className="absolute inset-0">
        ...
        {/* Middle accent */}
        <div
          className="absolute top-1/3 right-0 w-80 h-80 bg-gradient-to-bl from-red-500/30 to-transparent rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
        ...
        >
          <div className="relative">
            {/* Glow effect */}
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-600 to-red-600 blur-2xl opacity-50 -z-10" />
        ...
        >
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-blue-500 via-red-500 to-blue-500 mx-auto mb-4" />
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <div className="w-3 h-3 bg-red-400 rounded-full animate-bounce" style={{ animationDelay: "200ms" }} />
            <div className="w-3 h-3 bg-blue-400 rounded-full animate-bounce" style={{ animationDelay: "400ms" }} />
          </div>
