      ...
      <main className="flex-1 container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="mb-6 lg:mb-8">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-muted-foreground">
            Visualize e edite o histórico de chamadas das suas turmas
          </p>
        </div>

        <div className="grid gap-3 sm:gap-4 lg:gap-6 grid-cols-2 lg:grid-cols-3 mb-6 lg:mb-8">
        ...
        {studentsWithConsecutiveAbsences.length > 0 && (
          <Card className="border-2 border-destructive/50 bg-destructive/5 mb-6">
            <CardHeader>
        ...
        {displayedDates.map((date) => {
          ...
          return (
            <Card key={date} className="border-2 mb-6">
              <CardHeader>
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-2">
                  {dateAttendances.map((attendance) => {
                    ...
                    return (
                      <Card key={attendance.id} className="border-2 cursor-pointer hover:shadow-md transition-shadow">
