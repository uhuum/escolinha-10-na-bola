...
export default function PaymentsPage() {
  ...
  const handlePixSplashComplete = () => {
    toast({
      title: "Pagamento confirmado",
      description: "Comprovante PIX anexado e pagamento marcado como pago",
    })
    setShowPaymentSplash(false)
    setPaymentSplashData(null)
    setSelectedStudent(null)
    ...
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <Card className="w-full max-w-md border-2">
            <CardHeader>
              ...
              <CardDescription>Selecione o arquivo do comprovante de pagamento</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
      ...
      {showPaymentSplash && paymentSplashData && (
        <PaymentSplash
          ...
          onComplete={selectedPaymentType === "pix" ? handlePixSplashComplete : handlePaymentSplashComplete}
        />
      )}
